...
<body>
    <div class="wrapper">
        <header>
            ...
            ?>
                <nav>
                    <ul><li style="float: revert-layer;"><a href="">
        ...
        <section>
			...
			<div class="box">
				...
				<h1 style="text-align: center;font-size:25px;">Closes at 16:00 hrs</h1><br>
                <h1 style="text-align: center;font-size:25px;"><a style="color: white;" href="../student/index.php" class="button">Go to Student Page</a></h1><br>
